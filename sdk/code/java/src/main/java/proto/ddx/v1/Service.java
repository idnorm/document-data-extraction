...
public final class Service {
  ...
  public interface ScanDocumentResponseOrBuilder extends
     ...
     * </pre>
     *
     * <code>bytes documentImage = 5 [json_name = "documentImage"];</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DOCUMENTIMAGE_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!documentImage_.isEmpty()) {
        output.writeBytes(5, documentImage_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!documentImage_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(5, documentImage_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public interface ScanTwoSidedDocumentResponseOrBuilder extends
     ...
     * </pre>
     *
     * <code>.proto.ddx.v1.DocumentData data = 3 [json_name = "data"];</code>
     * @return Whether the data field is set.
     */
    boolean hasData();
    /**
     ...
     * </pre>
     *
     * <code>bytes frontSideDocumentImage = 4 [json_name = "frontSideDocumentImage"];</code>
     * @return The frontSideDocumentImage.
     */
    com.google.protobuf.ByteString getFrontSideDocumentImage();
     ...
     * </pre>
     *
     * <code>bytes backSideDocumentImage = 5 [json_name = "backSideDocumentImage"];</code>
     * @return The backSideDocumentImage.
     */
    com.google.protobuf.ByteString getBackSideDocumentImage();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ScanTwoSidedDocumentResponse() {
      status_ = 0;
      frontSideDocumentImage_ = com.google.protobuf.ByteString.EMPTY;
      backSideDocumentImage_ = com.google.protobuf.ByteString.EMPTY;
    }
    ...
    public static final int FRONTSIDEDOCUMENTIMAGE_FIELD_NUMBER = 4;
    private com.google.protobuf.ByteString frontSideDocumentImage_ = com.google.protobuf.ByteString.EMPTY;
    /**
     * <pre>
     * Optional, empty by default, returned if specified in requests "config" field.
     * Will empty if document detection failed on the front image in the request
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getFrontSideDocumentImage() {
      return frontSideDocumentImage_;
    }

    public static final int BACKSIDEDOCUMENTIMAGE_FIELD_NUMBER = 5;
    private com.google.protobuf.ByteString backSideDocumentImage_ = com.google.protobuf.ByteString.EMPTY;
    /**
     * <pre>
     * Optional, empty by default, returned if specified in requests "config" field.
     * Will empty if document detection failed on the back image in the request
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getBackSideDocumentImage() {
      return backSideDocumentImage_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!frontSideDocumentImage_.isEmpty()) {
        output.writeBytes(4, frontSideDocumentImage_);
      }
      if (!backSideDocumentImage_.isEmpty()) {
        output.writeBytes(5, backSideDocumentImage_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!frontSideDocumentImage_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(4, frontSideDocumentImage_);
      }
      if (!backSideDocumentImage_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(5, backSideDocumentImage_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getFrontSideDocumentImage()
          .equals(other.getFrontSideDocumentImage())) return false;
      if (!getBackSideDocumentImage()
          .equals(other.getBackSideDocumentImage())) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FRONTSIDEDOCUMENTIMAGE_FIELD_NUMBER;
      hash = (53 * hash) + getFrontSideDocumentImage().hashCode();
      hash = (37 * hash) + BACKSIDEDOCUMENTIMAGE_FIELD_NUMBER;
      hash = (53 * hash) + getBackSideDocumentImage().hashCode();
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(proto.ddx.v1.Service.ScanTwoSidedDocumentResponse result) {
        ...
        if (((from_bitField0_ & 0x00000008) != 0)) {
          result.frontSideDocumentImage_ = frontSideDocumentImage_;
        }
        if (((from_bitField0_ & 0x00000010) != 0)) {
          result.backSideDocumentImage_ = backSideDocumentImage_;
        }
        result.bitField0_ |= to_bitField0_;
      }
      ...
      public Builder mergeFrom(proto.ddx.v1.Service.ScanTwoSidedDocumentResponse other) {
        ...
        if (other.getFrontSideDocumentImage() != com.google.protobuf.ByteString.EMPTY) {
          setFrontSideDocumentImage(other.getFrontSideDocumentImage());
        }
        if (other.getBackSideDocumentImage() != com.google.protobuf.ByteString.EMPTY) {
          setBackSideDocumentImage(other.getBackSideDocumentImage());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                frontSideDocumentImage_ = input.readBytes();
                bitField0_ |= 0x00000008;
                break;
              } // case 34
              case 42: {
                backSideDocumentImage_ = input.readBytes();
                bitField0_ |= 0x00000010;
                break;
              } // case 42
              default: {
       ...
       *
       * <code>bytes frontSideDocumentImage = 4 [json_name = "frontSideDocumentImage"];</code>
       * @param value The frontSideDocumentImage to set.
       * @return This builder for chaining.
       */
      public Builder setFrontSideDocumentImage(com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        frontSideDocumentImage_ = value;
        bitField0_ |= 0x00000008;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearFrontSideDocumentImage() {
        bitField0_ = (bitField0_ & ~0x00000008);
        frontSideDocumentImage_ = getDefaultInstance().getFrontSideDocumentImage();
        onChanged();
        return this;
      }
       ...
       *
       * <code>bytes backSideDocumentImage = 5 [json_name = "backSideDocumentImage"];</code>
       * @param value The backSideDocumentImage to set.
       * @return This builder for chaining.
       */
      public Builder setBackSideDocumentImage(com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        backSideDocumentImage_ = value;
        bitField0_ |= 0x00000010;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearBackSideDocumentImage() {
        bitField0_ = (bitField0_ & ~0x00000010);
        backSideDocumentImage_ = getDefaultInstance().getBackSideDocumentImage();
        onChanged();
        return this;
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "K_DIGIT_INVALID\020\002\"\240\003\n\024ScanDocumentRespon" +
      ...
      "(\0132\032.proto.ddx.v1.DocumentDataR\004data\022$\n\r" +
      "documentImage\030\005 \001(\014R\rdocumentImage\"x\n\006St" +
      "atus\022\r\n\tSTATUS_OK\020\000\022\035\n\031STATUS_DOCUMENT_N" +
      "OT_FOUND\020\001\022!\n\035STATUS_DOCUMENT_NOT_SUPPOR" +
      "TED\020\002\022\035\n\031STATUS_DOCUMENT_BACK_SIDE\020\003\"\325\002\n" +
      "\014DocumentData\0225\n\ttextField\030\001 \003(\0132\027.proto" +
      ".ddx.v1.TextFieldR\ttextField\022;\n\013visualFi" +
      "eld\030\002 \003(\0132\031.proto.ddx.v1.VisualFieldR\013vi" +
      "sualField\0225\n\tdateField\030\003 \003(\0132\027.proto.ddx" +
      ".v1.DateFieldR\tdateField\0222\n\010sexField\030\004 \003" +
      "(\0132\026.proto.ddx.v1.SexFieldR\010sexField\022#\n\003" +
      "mrz\030\005 \001(\0132\021.proto.ddx.v1.MrzR\003mrz\022A\n\rpdf" +
      "417Barcode\030\006 \001(\0132\033.proto.ddx.v1.Pdf417Ba" +
      "rcodeR\rpdf417Barcode\"\221\001\n\033ScanTwoSidedDoc" +
      ...
      "mentClassR\016classification\022.\n\004data\030\003 \001(\0132" +
      "\032.proto.ddx.v1.DocumentDataR\004data\0226\n\026fro" +
      "ntSideDocumentImage\030\004 \001(\014R\026frontSideDocu" +
      "mentImage\0224\n\025backSideDocumentImage\030\005 \001(\014" +
      "R\025backSideDocumentImage\"r\n\006Status\022\r\n\tSTA" +
      "TUS_OK\020\000\022\037\n\033STATUS_FRONT_SIDE_NOT_FOUND\020" +
      "\001\022\036\n\032STATUS_BACK_SIDE_NOT_FOUND\020\002\022\030\n\024STA" +
      "TUS_NOT_SUPPORTED\020\0032\215\002\n\nExtraction\022n\n\014Sc" +
      "anDocument\022!.proto.ddx.v1.ScanDocumentRe" +
      "quest\032\".proto.ddx.v1.ScanDocumentRespons" +
      "e\"\027\202\323\344\223\002\021\"\014/api/v1/scan:\001*\022\216\001\n\024ScanTwoSi" +
      "dedDocument\022).proto.ddx.v1.ScanTwoSidedD" +
      "ocumentRequest\032*.proto.ddx.v1.ScanTwoSid" +
      "edDocumentResponse\"\037\202\323\344\223\002\031\"\024/api/v1/scan" +
      "TwoSided:\001*B4Z2github.com/veridil/id-ext" +
      "ract-service/proto/ddx/v1b\006proto3"
    };
    ...
    internal_static_proto_ddx_v1_ScanDocumentResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_proto_ddx_v1_ScanDocumentResponse_descriptor,
        new java.lang.String[] { "Status", "Detection", "Classification", "Data", "DocumentImage", });
    internal_static_proto_ddx_v1_DocumentData_descriptor =
      getDescriptor().getMessageTypes().get(6);
    internal_static_proto_ddx_v1_DocumentData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_proto_ddx_v1_DocumentData_descriptor,
        new java.lang.String[] { "TextField", "VisualField", "DateField", "SexField", "Mrz", "Pdf417Barcode", });
    internal_static_proto_ddx_v1_ScanTwoSidedDocumentRequest_descriptor =
    ...
    internal_static_proto_ddx_v1_ScanTwoSidedDocumentResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_proto_ddx_v1_ScanTwoSidedDocumentResponse_descriptor,
        new java.lang.String[] { "Status", "Classification", "Data", "FrontSideDocumentImage", "BackSideDocumentImage", });
