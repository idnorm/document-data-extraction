...
type ScanDocumentResponse struct {
	...
	// status defines success level of the scan
	...
	DocumentImage []byte `protobuf:"bytes,5,opt,name=documentImage,proto3" json:"documentImage,omitempty"`
}
...
func (x *ScanDocumentResponse) GetDocumentImage() []byte {
	if x != nil {
...
type ScanTwoSidedDocumentResponse struct {
	...
	// data holds all information extracted from both sides of the document
	...
	FrontSideDocumentImage []byte `protobuf:"bytes,4,opt,name=frontSideDocumentImage,proto3" json:"frontSideDocumentImage,omitempty"`
	// Optional, empty by default, returned if specified in requests "config" field.
	// Will empty if document detection failed on the back image in the request
	BackSideDocumentImage []byte `protobuf:"bytes,5,opt,name=backSideDocumentImage,proto3" json:"backSideDocumentImage,omitempty"`
}
...
func (x *ScanTwoSidedDocumentResponse) GetData() *DocumentData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ScanTwoSidedDocumentResponse) GetFrontSideDocumentImage() []byte {
	if x != nil {
		return x.FrontSideDocumentImage
	}
	return nil
}

func (x *ScanTwoSidedDocumentResponse) GetBackSideDocumentImage() []byte {
	if x != nil {
		return x.BackSideDocumentImage
	}
	return nil
}
...
var file_proto_ddx_v1_service_proto_rawDesc = []byte{
	...
	0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x02, 0x22, 0xa0, 0x03, 0x0a, 0x14, 0x53, 0x63,
	...
	,
	...
	0x64, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x61, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xc0, 0x03, 0x0a, 0x1c, 0x53, 0x63, 0x61,
	...
	,
	...
	,
...
var file_proto_ddx_v1_service_proto_depIdxs = []int32{
	...
	9,  // 24: proto.ddx.v1.ScanTwoSidedDocumentResponse.data:type_name -> proto.ddx.v1.DocumentData
	12, // 25: proto.ddx.v1.ScanConfig.ReturnImage.targetResolution:type_name -> proto.ddx.v1.ScanConfig.ImgResolution
	27, // 26: proto.ddx.v1.ScanConfig.ReturnTextFieldImages.typeFilter:type_name -> proto.ddx.v1.TextField.Type
	28, // 27: proto.ddx.v1.ScanConfig.ReturnDateFieldImages.typeFilter:type_name -> proto.ddx.v1.DateField.Type
	29, // 28: proto.ddx.v1.ScanConfig.ReturnVisualFields.typeFilter:type_name -> proto.ddx.v1.VisualField.Type
	5,  // 29: proto.ddx.v1.Extraction.ScanDocument:input_type -> proto.ddx.v1.ScanDocumentRequest
	10, // 30: proto.ddx.v1.Extraction.ScanTwoSidedDocument:input_type -> proto.ddx.v1.ScanTwoSidedDocumentRequest
	8,  // 31: proto.ddx.v1.Extraction.ScanDocument:output_type -> proto.ddx.v1.ScanDocumentResponse
	11, // 32: proto.ddx.v1.Extraction.ScanTwoSidedDocument:output_type -> proto.ddx.v1.ScanTwoSidedDocumentResponse
